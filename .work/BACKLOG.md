...
| -------- | ----------- | --------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------- |
| BUG-001  | bug         | update migrates old `.hawp/usage` into `.hawp/work` | 2026-04-30 | [2026-04-30-bug-001-update-flow-migrate-old-layouts.md](status/2026-04-30-bug-001-update-flow-migrate-old-layouts.md) |
...
- Each item gets one plan file in `status/` — no two agents on the same ID.
