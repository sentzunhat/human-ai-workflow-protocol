...
func TestToolWorkIntakeReturnsReadyStructuredJSON(t *testing.T) {
	...
	response, err := runWorkIntake(context.Background(), root, "backlog alignment", 3, 2000, testRequestShaper{})
	if err != nil {
...
func TestToolWorkIntakeNoResultsNeedsUserInput(t *testing.T) {
	...
	response, err := runWorkIntake(context.Background(), root, "xyzzy_no_match_at_all", 3, 2000, testRequestShaper{})
	if err != nil {
		t.Fatalf("runWorkIntake: %v", err)
	}
...
func TestToolWorkIntakeMissingIndexIsStructuredBlocker(t *testing.T) {
	...
	response, err := runWorkIntake(context.Background(), root, "anything", 3, 2000, testRequestShaper{})
	if err != nil {
...
func TestToolWorkIntakeShapeFailureIsStructuredBlocker(t *testing.T) {
	...
	response, err := runWorkIntake(context.Background(), root, "backlog alignment", 3, 2000, failingRequestShaper{})
	if err != nil {
