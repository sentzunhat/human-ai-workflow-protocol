...
func TestOllamaLLMClientInterface(t *testing.T) {
	...
	var _ domainllm.LLMClient = client
}

func TestOllamaLLMUnreachable(t *testing.T) {
...
func TestOllamaLLMEmptyBatch(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.Method == "GET" && r.URL.Path == "/api/tags" {
			tagsHandler(w, "mistral")
			return
...
func TestOllamaLLMServerError(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func TestOllamaLLMContext(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.Method == "GET" && r.URL.Path == "/api/tags" {
			tagsHandler(w, "mistral")
			return
