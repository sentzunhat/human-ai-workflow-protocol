...
// `-ldflags="-X .../update.Version=vX.Y.Z"` (see librarian/go/Makefile).
...
// TagPrefix is prepended to the version in every release tag (see
// librarian/go/Makefile and .github/workflows/release-librarian-go.yml),
// e.g. tag "librarian-go-v0.0.2" for version "0.0.2".
