...
Downloadable script artifact: `claude/install/main.sh`.
...
- `distribution/generated/claude/install/main.md`

Generated shell script:

- `distribution/generated/claude/install/main.sh`

Provider: `claude` · Operation: `install` · Branch: `main`
...
- `distribution/sources/providers/claude/install/main.md`
