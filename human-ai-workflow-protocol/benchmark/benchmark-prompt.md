...
For authoring guidance on specific task types, see [hawp/AUTHORING_PATTERNS.md](../hawp/AUTHORING_PATTERNS.md).
...
- [hawp/AUTHORING_PATTERNS.md](../hawp/AUTHORING_PATTERNS.md) — how to fill the shape for specific task types
- [hawp/examples/](../hawp/examples/) — concrete filled-shape examples
- [hawp/SPEC.md](../hawp/SPEC.md) — field semantics and evidence discipline rules
