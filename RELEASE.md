...
sed -i '' 's/var Version = "dev"/var Version = "0.0.1"/' librarian/src/internal/domain/update/version.go
...
**File:** `librarian/src/internal/domain/update/version.go`
...
**File:** `librarian/src/CHANGELOG.md`
...
```bash
# Stage changes
git add librarian/src/internal/domain/update/version.go
git add librarian/src/CHANGELOG.md
...
GOOS=darwin GOARCH=arm64 go build -ldflags="-X github.com/sentzunhat/human-ai-workflow-protocol/librarian/src/internal/domain/update.Version=v0.0.1" -o hawp ./librarian/src/cmd/hawp
