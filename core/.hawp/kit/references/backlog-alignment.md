...
**IDs** are 8-character lowercase hex short-UUIDs (e.g. `b7e2a4f9`) generated by
`hawp work new "<title>"`. Legacy items may use `TASK-NNN` or date-prefixed formats;
the validator recognises all three forms.
