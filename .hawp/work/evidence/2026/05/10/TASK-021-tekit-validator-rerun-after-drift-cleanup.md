# Tekit Validator Rerun After Drift Cleanup
...
Checking 138 plan file(s)  (10 supporting file(s) skipped):
  Outcome: 0/138
  Verification: 1/138
  Close Checklist: 0/138

  [FAIL] Missing sections (2026-05-10 or later — must fix):
    BUG-156: ✗ missing Outcome, Verification, Close Checklist  (2026-05-10)
    BUG-157: ✗ missing Outcome, Verification, Close Checklist  (2026-05-11)
    BUG-158: ✗ missing Outcome, Verification, Close Checklist  (2026-05-11)

  [WARN] Legacy untyped closed files (before 2026-05-10 — tolerated, visible):
    2026-04-26-hawp-adr-template-review: legacy file without TASK-/BUG-style ID
 (2026-04-26)
  ...
  [INFO] Supporting files skipped by pattern:
    2026-05-02-backlog-archive-BUG-001-to-BUG-042: matches archive supporting-fi
le pattern  (2026-05-02)
    2026-05-02-backlog-archive-BUG-043-to-BUG-044: matches archive supporting-fi
le pattern  (2026-05-02)
    2026-05-02-backlog-archive-BUG-045-to-BUG-046: matches archive supporting-fi
le pattern  (2026-05-02)
    BUG-067-checkpoint: matches supporting suffix pattern (-checkpoint)  (2026-0
5-03)
    BUG-069-checkpoint: matches supporting suffix pattern (-checkpoint)  (2026-0
5-03)
    BUG-071-checkpoint: matches supporting suffix pattern (-checkpoint)  (2026-0
5-03)
    BUG-072-close-gate-checkpoint: matches supporting suffix pattern (-close-gat
e-checkpoint)  (2026-05-03)
    BUG-072-final-checkpoint: matches supporting suffix pattern (-final-checkpoi
nt)  (2026-05-03)
```
