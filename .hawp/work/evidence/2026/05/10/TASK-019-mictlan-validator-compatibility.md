# TASK-019 Mictlan Validator Compatibility

- Target: `mictlan/.hawp`
- Command: `npm run validate:workflow -- --hawp-root mictlan/.hawp`
- Exit code: `1`
...
> tsx scripts/validate-hawp-workflow/index.ts --hawp-root mictlan/.hawp
