...
Done. Link checking admits only regular Markdown roots/files, and apply mode
rejects symlink ancestors and non-regular targets before reading or writing.
The clean/check implementation and focused application tests pass.
