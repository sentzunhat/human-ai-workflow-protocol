...
Done. Search ingest walkers accept only regular Markdown files, while the
enriched build path rejects symlinked corpus roots and descendants before
indexing or JSON export. Focused regressions cover broken and readable
symlinked documents plus corpus-root/descendant links.
