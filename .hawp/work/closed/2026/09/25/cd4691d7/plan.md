...
- [x] Obtain explicit approval and reconcile overlapping changes before implementation

## Outcome

Done. Kitsync destination mutations reject symlink ancestors before directory
creation, temporary-file creation, and rename across kit/provider copy paths.
Focused kitsync and infrastructure tests pass; the previously noted overlap is
now reconciled in the checked-out implementation.
