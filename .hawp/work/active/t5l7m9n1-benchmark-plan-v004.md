...
| Benchmark harness (`go test` suite) | `librarian/go/benchmarks/` | Stub only |
...
- [ ] Scaffold `librarian/go/benchmarks/` harness structure
...
1. **Immediate (before v0.0.4):**
   ...
   - Scaffold `librarian/go/benchmarks/harness.go`
