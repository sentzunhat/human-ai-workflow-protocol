...
- [ ] Live ready-state smoke with a real matching repository index remains
  unproven in this pass; the current live index did not produce a usable
  context-backed draft.
- [ ] `hawp work validate` remains blocked by pre-existing closed-plan
  completeness issues in `288d543c`, `5b90af26`, `86c3911c`, and `a3df8a9c`.
